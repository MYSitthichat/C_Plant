        ...
        while self.main_condition_load_running:
            try:
                if self.state_main_condition_load == 0:
                    ...
                    print(f"\n🔄 === STATE 5: POST-MIXING PROCESSING ===")
                    ...
                    print(f"   Next queue ready: {self.next_queue_loaded_and_ready}")
                    print(f"   Current transport queue: {self.current_queue_transporting}")
                    print(f"   Total queue count: {self.total_queue_count}")
                    print(f"   Has more queues: {has_more_queues}")
                    
                    if not has_more_queues:
                        # ไม่มีคิวรออีกแล้ว ปิด mixer ตามปกติ
                        print("🏁 No more queues - finalizing mixing process")
                    ...
                    print("📊 Accumulating batch weights...")
                    ...
                    if self.next_queue_loaded_and_ready:
                        ...
                        print("⚡ Next queue ready - starting immediate transport")
                        self.close_vale_mixer_when_waiting = True
                        ...
                        print("🎯 === ALL QUEUES COMPLETED - FINALIZING ===")
                        print(f"   Total queues processed: {self.current_queue_transporting}")
                        print(f"   Total cubes completed: {self.get_all_loaded_cube}")
