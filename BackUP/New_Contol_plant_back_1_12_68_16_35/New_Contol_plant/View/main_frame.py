...
class Ui_Control_Plant(object):
    def setupUi(self, Control_Plant):
        ...
        self.work_groupBox = QGroupBox(self.work_tab)
        ...
        self.work_start_pushButton = QPushButton(self.work_tab)
        self.work_start_pushButton.setObjectName(u"work_start_pushButton")
        self.work_start_pushButton.setGeometry(QRect(1000, 720, 271, 61))
        self.work_start_pushButton.setFont(font)
        self.work_cancel_pushButton = QPushButton(self.work_tab)
        self.work_cancel_pushButton.setObjectName(u"work_cancel_pushButton")
        self.work_cancel_pushButton.setGeometry(QRect(1280, 720, 271, 61))
        self.work_cancel_pushButton.setFont(font)
        self.tab.addTab(self.work_tab, "")
        ...
        self.mix_monitor_rock_1_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_sand_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_rock_2_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_fyash_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_cement_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_water_label = QLabel(self.mix_main_monitor_groupBox)
        self.mix_monitor_water_label.setObjectName(u"mix_monitor_water_label")
        self.mix_monitor_water_label.setGeometry(QRect(720, 95, 120, 91))
        self.mix_monitor_water_label.setFont(font)
        self.mix_monitor_water_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        self.mix_monitor_water_label.setFrameShape(QFrame.Shape.Box)
        self.mix_monitor_water_label.setFrameShadow(QFrame.Shadow.Plain)
        self.mix_monitor_water_label.setLineWidth(2)
        self.mix_monitor_water_label.setAlignment(Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
        ...
        self.mix_monitor_chem_2_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_chem_1_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_water_lineEdit = QLineEdit(self.mix_main_monitor_groupBox)
        self.mix_monitor_water_lineEdit.setObjectName(u"mix_monitor_water_lineEdit")
        self.mix_monitor_water_lineEdit.setGeometry(QRect(730, 140, 101, 41))
        self.mix_monitor_water_lineEdit.setFont(font1)
        self.mix_monitor_water_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.mix_monitor_mixer_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_converyer_rock_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_vale_fyash_and_cement_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_vale_wather_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_pump_chem_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_main_vale_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_sum_rock_and_sand_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_sum_chem_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_sum_fyash_and_cement_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.mix_monitor_water_label.raise_()
        ...
        self.mix_monitor_water_lineEdit.raise_()
        ...
        self.mix_wieght_Loaded_label.setGeometry(QRect(75, 30, 81, 41))
        ...
        self.mix_wieght_target_label.setGeometry(QRect(175, 30, 81, 41))
        ...
        self.mix_wieght_Loaded_rock_1_lineEdit.setGeometry(QRect(75, 130, 81, 41))
        ...
        self.mix_wieght_Loaded_rock_1_label.setGeometry(QRect(5, 130, 61, 41))
        ...
        self.mix_wieght_Loaded_sand_label.setGeometry(QRect(5, 80, 51, 41))
        ...
        self.mix_wieght_Loaded_rock_2_label.setGeometry(QRect(5, 180, 61, 41))
        ...
        self.mix_wieght_Loaded_cement_label.setGeometry(QRect(5, 230, 61, 41))
        ...
        self.mix_wieght_Loaded_fyash_label.setGeometry(QRect(5, 280, 71, 41))
        self.mix_wieght_Loaded_fyash_label.setFont(font3)
        self.mix_wieght_Loaded_water_label = QLabel(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_Loaded_water_label.setObjectName(u"mix_wieght_Loaded_water_label")
        self.mix_wieght_Loaded_water_label.setGeometry(QRect(5, 330, 61, 41))
        self.mix_wieght_Loaded_water_label.setFont(font3)
        ...
        self.mix_wieght_Loaded_chem_1_label.setGeometry(QRect(5, 380, 61, 41))
        ...
        self.mix_wieght_Loaded_chem_2_label.setGeometry(QRect(5, 430, 61, 41))
        ...
        self.mix_wieght_Loaded_sand_lineEdit.setGeometry(QRect(75, 80, 81, 41))
        ...
        self.mix_wieght_Loaded_rock_2_lineEdit.setGeometry(QRect(75, 180, 81, 41))
        ...
        self.mix_wieght_Loaded_cement_lineEdit.setGeometry(QRect(75, 230, 81, 41))
        ...
        self.mix_wieght_Loaded_fyash_lineEdit.setGeometry(QRect(75, 280, 81, 41))
        ...
        self.mix_wieght_Loaded_water_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_Loaded_water_lineEdit.setObjectName(u"mix_wieght_Loaded_water_lineEdit")
        self.mix_wieght_Loaded_water_lineEdit.setGeometry(QRect(75, 330, 81, 41))
        self.mix_wieght_Loaded_water_lineEdit.setFont(font3)
        self.mix_wieght_Loaded_water_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.mix_wieght_Loaded_chem_1_lineEdit.setGeometry(QRect(75, 380, 81, 41))
        ...
        self.mix_wieght_Loaded_chem_2_lineEdit.setGeometry(QRect(75, 430, 81, 41))
        ...
        self.mix_wieght_target_sand_lineEdit.setGeometry(QRect(175, 80, 81, 41))
        ...
        self.mix_wieght_target_water_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_target_water_lineEdit.setObjectName(u"mix_wieght_target_water_lineEdit")
        self.mix_wieght_target_water_lineEdit.setGeometry(QRect(175, 330, 81, 41))
        self.mix_wieght_target_water_lineEdit.setFont(font3)
        self.mix_wieght_target_water_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.mix_wieght_target_rock_2_lineEdit.setGeometry(QRect(175, 180, 81, 41))
        ...
        self.mix_wieght_target_rock_1_lineEdit.setGeometry(QRect(175, 130, 81, 41))
        ...
        self.mix_wieght_target_cement_lineEdit.setGeometry(QRect(175, 230, 81, 41))
        ...
        self.mix_wieght_target_chem_2_lineEdit.setGeometry(QRect(175, 430, 81, 41))
        ...
        self.mix_wieght_target_fyash_lineEdit.setGeometry(QRect(175, 280, 81, 41))
        ...
        self.mix_wieght_target_chem_1_lineEdit.setGeometry(QRect(175, 380, 81, 41))
        ...
        self.mix_wieght_sum_rock_1_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_rock_1_lineEdit.setObjectName(u"mix_wieght_sum_rock_1_lineEdit")
        self.mix_wieght_sum_rock_1_lineEdit.setGeometry(QRect(275, 130, 81, 41))
        self.mix_wieght_sum_rock_1_lineEdit.setFont(font3)
        self.mix_wieght_sum_rock_1_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.mix_wieght_sum_rock_2_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_rock_2_lineEdit.setObjectName(u"mix_wieght_sum_rock_2_lineEdit")
        self.mix_wieght_sum_rock_2_lineEdit.setGeometry(QRect(275, 180, 81, 41))
        self.mix_wieght_sum_rock_2_lineEdit.setFont(font3)
        self.mix_wieght_sum_rock_2_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.mix_wieght_sum_fyash_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_fyash_lineEdit.setObjectName(u"mix_wieght_sum_fyash_lineEdit")
        self.mix_wieght_sum_fyash_lineEdit.setGeometry(QRect(275, 280, 81, 41))
        self.mix_wieght_sum_fyash_lineEdit.setFont(font3)
        self.mix_wieght_sum_fyash_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.mix_wieght_sum_label = QLabel(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_label.setObjectName(u"mix_wieght_sum_label")
        self.mix_wieght_sum_label.setGeometry(QRect(285, 30, 61, 41))
        self.mix_wieght_sum_label.setFont(font3)
        self.mix_wieght_sum_water_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_water_lineEdit.setObjectName(u"mix_wieght_sum_water_lineEdit")
        self.mix_wieght_sum_water_lineEdit.setGeometry(QRect(275, 330, 81, 41))
        self.mix_wieght_sum_water_lineEdit.setFont(font3)
        self.mix_wieght_sum_water_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.mix_wieght_sum_cement_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_cement_lineEdit.setObjectName(u"mix_wieght_sum_cement_lineEdit")
        self.mix_wieght_sum_cement_lineEdit.setGeometry(QRect(275, 230, 81, 41))
        self.mix_wieght_sum_cement_lineEdit.setFont(font3)
        self.mix_wieght_sum_cement_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.mix_wieght_sum_chem_1_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_chem_1_lineEdit.setObjectName(u"mix_wieght_sum_chem_1_lineEdit")
        self.mix_wieght_sum_chem_1_lineEdit.setGeometry(QRect(275, 380, 81, 41))
        self.mix_wieght_sum_chem_1_lineEdit.setFont(font3)
        self.mix_wieght_sum_chem_1_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.mix_wieght_sum_sand_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_sand_lineEdit.setObjectName(u"mix_wieght_sum_sand_lineEdit")
        self.mix_wieght_sum_sand_lineEdit.setGeometry(QRect(275, 80, 81, 41))
        self.mix_wieght_sum_sand_lineEdit.setFont(font3)
        self.mix_wieght_sum_sand_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.mix_wieght_sum_chem_2_lineEdit = QLineEdit(self.mix_wieght_monitor_groupBox)
        self.mix_wieght_sum_chem_2_lineEdit.setObjectName(u"mix_wieght_sum_chem_2_lineEdit")
        self.mix_wieght_sum_chem_2_lineEdit.setGeometry(QRect(275, 430, 81, 41))
        self.mix_wieght_sum_chem_2_lineEdit.setFont(font3)
        self.mix_wieght_sum_chem_2_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.for_name_formula_label.setGeometry(QRect(40, 40, 81, 41))
        ...
        self.for_name_formula_lineEdit.setGeometry(QRect(10, 90, 131, 41))
        ...
        self.for_rock_1_label.setGeometry(QRect(190, 40, 51, 41))
        ...
        self.for_sand_label.setGeometry(QRect(305, 40, 71, 41))
        ...
        self.for_rock_2_label.setGeometry(QRect(440, 40, 71, 41))
        ...
        self.for_fyash_label.setGeometry(QRect(700, 40, 91, 41))
        ...
        self.for_cement_label.setGeometry(QRect(580, 40, 41, 41))
        self.for_cement_label.setFont(font)
        self.for_water_label = QLabel(self.for_config_formula_groupBox)
        self.for_water_label.setObjectName(u"for_water_label")
        self.for_water_label.setGeometry(QRect(855, 40, 41, 41))
        self.for_water_label.setFont(font)
        self.for_chem_1_label = QLabel(self.for_config_formula_groupBox)
        self.for_chem_1_label.setObjectName(u"for_chem_1_label")
        self.for_chem_1_label.setGeometry(QRect(960, 40, 121, 41))
        ...
        self.for_chem_2_label.setGeometry(QRect(1100, 40, 121, 41))
        ...
        self.for_age_label.setGeometry(QRect(1280, 40, 51, 41))
        ...
        self.for_rock_1_lineEdit = QLineEdit(self.for_config_formula_groupBox)
        self.for_rock_1_lineEdit.setObjectName(u"for_rock_1_lineEdit")
        self.for_rock_1_lineEdit.setGeometry(QRect(160, 90, 101, 41))
        self.for_rock_1_lineEdit.setFont(font1)
        self.for_rock_1_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.for_sand_lineEdit.setGeometry(QRect(280, 90, 111, 41))
        ...
        self.for_rock_2_lineEdit.setGeometry(QRect(410, 90, 111, 41))
        ...
        self.for_fyash_lineEdit.setGeometry(QRect(540, 90, 131, 41))
        ...
        self.for_cement_lineEdit.setGeometry(QRect(690, 90, 111, 41))
        self.for_cement_lineEdit.setFont(font1)
        self.for_cement_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.for_water_lineEdit = QLineEdit(self.for_config_formula_groupBox)
        self.for_water_lineEdit.setObjectName(u"for_water_lineEdit")
        self.for_water_lineEdit.setGeometry(QRect(820, 90, 111, 41))
        self.for_water_lineEdit.setFont(font1)
        self.for_water_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.for_chem_1_lineEdit.setGeometry(QRect(950, 90, 121, 41))
        ...
        self.for_chem_2_lineEdit.setGeometry(QRect(1090, 90, 131, 41))
        ...
        self.for_age_lineEdit.setGeometry(QRect(1240, 90, 131, 41))
        ...
        self.debug_rock_1_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_sand_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_rock_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_converyer_under_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_converyer_top_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_cement_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_fyash_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_vale_cement_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_vale_water_label = QLabel(self.debug_control_groupBox)
        self.debug_vale_water_label.setObjectName(u"debug_vale_water_label")
        self.debug_vale_water_label.setGeometry(QRect(1160, 160, 351, 71))
        self.debug_vale_water_label.setFont(font3)
        self.debug_vale_water_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        self.debug_vale_water_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.debug_mixer_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_close_vale_mixer_pushButton.setGeometry(QRect(900, 500, 141, 51))
        ...
        self.debug_vale_mixer_label.setGeometry(QRect(570, 460, 491, 101))
        self.debug_vale_mixer_label.setFont(font3)
        self.debug_vale_mixer_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_open_vale_mixer_pushButton.setGeometry(QRect(590, 500, 141, 51))
        ...
        self.debug_chem_1_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_chem_2_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_vale_chem_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_water_label = QLabel(self.debug_control_groupBox)
        self.debug_water_label.setObjectName(u"debug_water_label")
        self.debug_water_label.setGeometry(QRect(1210, 50, 251, 101))
        self.debug_water_label.setFont(font3)
        self.debug_water_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        self.debug_water_label.setAlignment(Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
        ...
        self.debug_plate_1_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_plate_2_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        ...
        self.debug_plate_3_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        self.debug_plate_3_label.setAlignment(Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
        self.debug_plate_vibration_label = QLabel(self.debug_control_groupBox)
        self.debug_plate_vibration_label.setObjectName(u"debug_plate_vibration_label")
        self.debug_plate_vibration_label.setGeometry(QRect(30, 40, 451, 171))
        self.debug_plate_vibration_label.setFont(font3)
        self.debug_plate_vibration_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        self.debug_plate_vibration_label.setAlignment(Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
        self.debug_close_vibrater_cement_fyash_pushButton = QPushButton(self.debug_control_groupBox)
        self.debug_close_vibrater_cement_fyash_pushButton.setObjectName(u"debug_close_vibrater_cement_fyash_pushButton")
        self.debug_close_vibrater_cement_fyash_pushButton.setGeometry(QRect(330, 140, 131, 51))
        self.debug_close_vibrater_cement_fyash_pushButton.setFont(font3)
        self.debug_vibrater_cement_fyash_label = QLabel(self.debug_control_groupBox)
        self.debug_vibrater_cement_fyash_label.setObjectName(u"debug_vibrater_cement_fyash_label")
        self.debug_vibrater_cement_fyash_label.setGeometry(QRect(40, 130, 431, 71))
        self.debug_vibrater_cement_fyash_label.setFont(font3)
        self.debug_vibrater_cement_fyash_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        self.debug_vibrater_cement_fyash_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.debug_open_vibrater_rock_sand_pushButton = QPushButton(self.debug_control_groupBox)
        self.debug_open_vibrater_rock_sand_pushButton.setObjectName(u"debug_open_vibrater_rock_sand_pushButton")
        self.debug_open_vibrater_rock_sand_pushButton.setGeometry(QRect(190, 60, 121, 51))
        self.debug_open_vibrater_rock_sand_pushButton.setFont(font3)
        self.debug_close_vibrater_rock_sand_pushButton = QPushButton(self.debug_control_groupBox)
        self.debug_close_vibrater_rock_sand_pushButton.setObjectName(u"debug_close_vibrater_rock_sand_pushButton")
        self.debug_close_vibrater_rock_sand_pushButton.setGeometry(QRect(330, 60, 131, 51))
        self.debug_close_vibrater_rock_sand_pushButton.setFont(font3)
        self.debug_open_vibrater_cement_fyash_pushButton = QPushButton(self.debug_control_groupBox)
        self.debug_open_vibrater_cement_fyash_pushButton.setObjectName(u"debug_open_vibrater_cement_fyash_pushButton")
        self.debug_open_vibrater_cement_fyash_pushButton.setGeometry(QRect(190, 140, 121, 51))
        self.debug_open_vibrater_cement_fyash_pushButton.setFont(font3)
        self.debug_vibrater_rock_sand_label = QLabel(self.debug_control_groupBox)
        self.debug_vibrater_rock_sand_label.setObjectName(u"debug_vibrater_rock_sand_label")
        self.debug_vibrater_rock_sand_label.setGeometry(QRect(40, 50, 431, 71))
        self.debug_vibrater_rock_sand_label.setFont(font3)
        self.debug_vibrater_rock_sand_label.setStyleSheet(u"border: 2px solid; \n"
"border-radius: 10px;")
        self.debug_vibrater_rock_sand_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.debug_off_vale_mixer_pushButton = QPushButton(self.debug_control_groupBox)
        self.debug_off_vale_mixer_pushButton.setObjectName(u"debug_off_vale_mixer_pushButton")
        self.debug_off_vale_mixer_pushButton.setGeometry(QRect(750, 500, 131, 51))
        self.debug_off_vale_mixer_pushButton.setFont(font3)
        self.debug_plate_vibration_label.raise_()
        self.debug_vibrater_cement_fyash_label.raise_()
        self.debug_vibrater_rock_sand_label.raise_()
        self.debug_plate_3_label.raise_()
        self.debug_plate_2_label.raise_()
        self.debug_plate_1_label.raise_()
        self.debug_water_label.raise_()
        ...
        self.debug_vale_water_label.raise_()
        ...
        self.debug_close_vibrater_cement_fyash_pushButton.raise_()
        self.debug_open_vibrater_rock_sand_pushButton.raise_()
        self.debug_close_vibrater_rock_sand_pushButton.raise_()
        self.debug_open_vibrater_cement_fyash_pushButton.raise_()
        self.debug_off_vale_mixer_pushButton.raise_()
        ...
        self.offset_water_label = QLabel(self.offset_setting_formular_groupBox)
        self.offset_water_label.setObjectName(u"offset_water_label")
        self.offset_water_label.setGeometry(QRect(740, 40, 71, 61))
        self.offset_water_label.setFont(font3)
        self.offset_water_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.offset_water_lineEdit = QLineEdit(self.offset_setting_formular_groupBox)
        self.offset_water_lineEdit.setObjectName(u"offset_water_lineEdit")
        self.offset_water_lineEdit.setGeometry(QRect(820, 40, 91, 61))
        self.offset_water_lineEdit.setFont(font1)
        self.offset_water_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.offset_water_label.raise_()
        self.offset_chem_1_label.raise_()
        self.offset_water_lineEdit.raise_()
    ...
    def retranslateUi(self, Control_Plant):
        Control_Plant.setWindowTitle(QCoreApplication.translate("Control_Plant", u"MAIN CONTROL PLANT", None))
        ...
        self.work_start_pushButton.setText(QCoreApplication.translate("Control_Plant", u"\u0e40\u0e23\u0e34\u0e48\u0e21\u0e01\u0e32\u0e23\u0e17\u0e33\u0e07\u0e32\u0e19\u0e17\u0e35\u0e48\u0e40\u0e25\u0e37\u0e2d\u0e01", None))
        self.work_cancel_pushButton.setText(QCoreApplication.translate("Control_Plant", u"\u0e22\u0e01\u0e40\u0e25\u0e34\u0e01\u0e01\u0e32\u0e23\u0e17\u0e33\u0e07\u0e32\u0e19\u0e17\u0e35\u0e48\u0e40\u0e25\u0e37\u0e2d\u0e01", None))
        self.tab.setTabText(self.tab.indexOf(self.work_tab), QCoreApplication.translate("Control_Plant", u"Work", None))
        ...
        self.mix_monitor_water_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e19\u0e49\u0e33", None))
        ...
        self.mix_wieght_Loaded_rock_1_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e2b\u0e34\u0e19 3/8", None))
        self.mix_wieght_Loaded_sand_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e17\u0e23\u0e32\u0e22", None))
        self.mix_wieght_Loaded_rock_2_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e2b\u0e34\u0e19 3/4", None))
        ...
        self.mix_wieght_Loaded_water_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e19\u0e49\u0e33", None))
        ...
        self.mix_wieght_sum_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e1c\u0e25\u0e23\u0e27\u0e21", None))
        ...
        self.for_water_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e19\u0e49\u0e33", None))
        ...
        self.debug_vale_water_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e27\u0e32\u0e25\u0e4c\u0e27\u0e19\u0e49\u0e33", None))
        ...
        self.debug_vale_chem_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e1b\u0e31\u0e49\u0e21\u0e19\u0e49\u0e33\u0e22\u0e32", None))
        ...
        self.debug_water_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e19\u0e49\u0e33", None))
        self.debug_plate_1_label.setText("")
        self.debug_plate_2_label.setText("")
        self.debug_plate_3_label.setText("")
        self.debug_plate_vibration_label.setText("")
        self.debug_close_vibrater_cement_fyash_pushButton.setText(QCoreApplication.translate("Control_Plant", u"\u0e1b\u0e34\u0e14", None))
        self.debug_vibrater_cement_fyash_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e21\u0e2d\u0e40\u0e15\u0e2d\u0e23\u0e4c\u0e2a\u0e31\u0e48\u0e19\u0e1b\u0e39\u0e19", None))
        self.debug_open_vibrater_rock_sand_pushButton.setText(QCoreApplication.translate("Control_Plant", u"\u0e40\u0e1b\u0e34\u0e14", None))
        self.debug_close_vibrater_rock_sand_pushButton.setText(QCoreApplication.translate("Control_Plant", u"\u0e1b\u0e34\u0e14", None))
        self.debug_open_vibrater_cement_fyash_pushButton.setText(QCoreApplication.translate("Control_Plant", u"\u0e40\u0e1b\u0e34\u0e14", None))
        self.debug_vibrater_rock_sand_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e21\u0e2d\u0e40\u0e15\u0e2d\u0e23\u0e4c\u0e2a\u0e31\u0e48\u0e19\u0e22\u0e38\u0e49\u0e07", None))
        self.debug_off_vale_mixer_pushButton.setText(QCoreApplication.translate("Control_Plant", u"off \u0e27\u0e32\u0e25\u0e4c\u0e27", None))
        ...
        self.offset_water_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e19\u0e49\u0e33", None))
        ...
        self.offset_converyer_silo_time_label.setText(QCoreApplication.translate("Control_Plant", u"\u0e40\u0e27\u0e25\u0e32\u0e19\u0e31\u0e1a\u0e16\u0e2d\u0e22\u0e2b\u0e25\u0e31\u0e07\u0e01\u0e32\u0e23\u0e1b\u0e34\u0e14\u0e2a\u0e32\u0e22\u0e1e\u0e32\u0e19", None))
