...
number_font = font.Font(size=10,weight="bold")
...
customer_phone_number_entry = tk.Entry(master = top_frame,width=30,font=number_font)
...
booking_calendar = DateEntry(master=top_frame, width=15, background='darkblue', foreground='white', borderwidth=2,font=number_font, justify='center',date_pattern='dd/MM/yyyy')
...
booking_hour = tk.Entry(master=top_frame,width=6,font=number_font,justify='center')
booking_hour.insert(0,'08')
...
booking_minute = tk.Entry(master=top_frame,width=6,font=number_font,justify='center')
booking_minute.insert(0,'00')
...
booking_concrete_spinbox = tk.Spinbox(master=top_frame,width=15,font=number_font,textvariable=concrete_type)
...
order_quantity = tk.Entry(master=top_frame,width=5,font=number_font,justify='center')
