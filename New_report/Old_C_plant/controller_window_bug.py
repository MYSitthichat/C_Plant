    ...
    try:
        ...
        # ========= set flyash weight ==============
            ...
            if current_amount <= 0.5:
                flyash_weight_int = int((flyash_float)*0.96)+393                            # last modify 22 december
            else:
                flyash_weight_int = int((flyash_float)*0.94)+392                            # previous constant value = 398  ;;; when add 398 the weight are 4 kg more than set point
        ...
        # ========= set cemen weight (flyash+cemen) =====
            ...
            current_amount = float(amount_string.get())
            if current_amount <= 0.5:
                cemen_weight_int = int((f1+c1)*0.96)+393                                # last modify 22 december
            else:
        ...
        #=========== refill cemen =================
            ...
            if running:
                ...
                if modbus_result.function_code < 0x80:
                    ...
                    if abs(present_cemen_weight-cemen_weight_target) <= 3:
                        # main_state = 309
                        main_state = 450
                    else:
                        main_state = 351
