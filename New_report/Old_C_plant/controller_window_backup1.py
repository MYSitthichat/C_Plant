...
def add_bill(customer_name,address,cemen_formula,cemen_amount):
    # global input_path
    # global font_path
    output_temp_file = "/home/plant/Documents/CemenPlant/bills/temp_bill.pdf"
    ...
    fpdf.alias_nb_pages()
    fpdf.add_page()
    fpdf.add_font("THNiramit", "", "/home/plant/Documents/CemenPlant/fonts/THNiramitAS.ttf", uni=True)
    ...
    fpdf.text(53,108,name_plate_string)
    ...
    fpdf.text(53,229,name_plate_string)
...
display_client = ModbusClient(method='rtu',port='/dev/ttyUSB1',stopbitd=1,bytesize=8,parity='N',baudrate=9600,timeout=1)
...
def main_controller():
    ...
    try:
        ...
        # set sand weights to PLC1
            ...
            sand_float = float(sand_target_weight_string.get())*0.21 + 271
        ...
        # set rock2 weights to PLC1 (rock1 + rock2 + sand)
            ...
            rock2_weight_int = int((s1+r1+r2)*0.21 + 271)
            if running:
        ...
        # ========= set flyash weight ==============
            ...
            if current_amount <= 0.5:
                flyash_weight_int = int((flyash_float)*0.96)+376
            else:
                flyash_weight_int = int((flyash_float)*0.96)+376
        ...
        # ========= set cemen weight (flyash+cemen) =====
            ...
            current_amount = float(amount_string.get())
            if current_amount <= 0.5:
                cemen_weight_int = int((f1+c1)*0.96)+376
            else:
                cemen_weight_int = int((f1+c1)*0.96)+376
        ...
        # ======== set water weight =============
            ...
            current_amount = float(amount_string.get())
            if current_amount <= 0.5:
                water_weight_int = int(water_weight_float*0.95)+341
            else:
                water_weight_int = int(water_weight_float*0.95)+341
        ...
        # ======= set chem1 weight =============
            ...
            chem1_weight_int = int(float(chem1_target_weight_string.get())*190)+170
            if running:
        ...
        # ======= set chem2 weight (chem1+chem2) =============
            ...
            chem2_weight_int = int((c1+c2)*190)+170
            if running:
         ...
         # ========== read rock2 weight ===========
            ...
            if running:
                ...
                if modbus_result.function_code < 0x80:
                    ...
                    rock2_weight = rock1_plus_rock2_plus_sand_weight - int(rock1_weight_string.get()) - int(rock2_weight_string.get())
